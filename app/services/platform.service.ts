...
export class PlatformService {
    ...
    public printPlatformInfo() {
        ...
        console.log('This device OS is ' + this.deviceInformation.os);
        console.log('This device type is ' + this.deviceInformation.deviceType);
        console.log('This device screen is ' + this.screenInformation.widthPixels + 'X' + this.screenInformation.heightPixels + ' pixels');
